<template>
    ...
    <div class="row">
        <router-link to="/journal" class="btn btn-primary">Journal</router-link>
              ...
              <div class="col-lg-12">
                <div class="login-form">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Journal Update</h1>
                  </div>

                  <form class="user" @submit.prevent="journalUpdate">
                  
                    <div class="form-group">
                        <div class="form-row">
                            <div class="col-md-12">
                                <label for="exampleFormControlTextarea1"><b>Journal</b></label>
...
data(){
  ...
  methods: {
    journalUpdate(){
        let id = this.$route.params.id;
      axios.patch('/api/journal/'+id, this.form)
      .then(res => {
