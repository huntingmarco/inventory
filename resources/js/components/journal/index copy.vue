<template>
    <div>
        ...
        <div class="row">
            <router-link to="/store-journal" class="btn btn-primary">Add Journal Entry</router-link>
              ...
              <div class="card mb-6">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" v-for="journaluser in journalusers" :key="journaluser.user">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false" @click="otherusers(journaluser.user)" >{{ journaluser.user }}</a>
                        </li>
                    </ul>
