                ...
                <div class="app-sidebar colored">
                    <div class="sidebar-header">
                        <a class="header-brand" href="index.html">
                            <div class="logo-img">
                               <img src="{{ asset('backend/src/img/brand-white.svg')}}" class="header-brand-img" alt="lavalite"> 
                            </div>
                    ...
                    <div class="sidebar-content">
                        <div class="nav-container">
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-lavel">Hotel Management</div>
                                <div class="nav-item has-sub">
                                ...
                                <div class="nav-lavel">Cashiering</div>
                                <div class="nav-item has-sub">
                                    <a href="#"><i class="ik ik-edit"></i><span>Forms</span></a>
                                    <router-link class="menu-item" to="/pos">Point of Sale</router-link>
                                    <div class="submenu-content">
                            ...
                            <div class="col-md-4">
                                <div class="card">
                                    ...
                                    <div class="card-body chat-box scrollable" style="height:300px;">
                                        <ul class="chat-list">
                                            <li class="chat-item">
                                                <div class="chat-img"><img src="{{ asset('backend/img/users/1.jpg')}}" alt="user"></div>
